...
HD_PWD='D:/project/vivado_2020_prj/Chip_development/SI5351/SI5351/SI5351.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SI5351.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SI5351.tcl -notrace
