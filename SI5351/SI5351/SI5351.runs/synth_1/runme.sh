...
HD_PWD='D:/project/vivado_2020_prj/Chip_development/SI5351/SI5351/SI5351.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SI5351.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SI5351.tcl
